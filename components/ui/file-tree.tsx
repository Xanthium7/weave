    ...
    return (
      ...
      >
        <div className={cn("size-full", className)}>
          <div
            ref={ref}
            className={cn("relative h-full px-2 overflow-y-auto", className)}
          >
...
>(({ className, elements, expandAll = false, children, ...props }, ref) => {
  ...
  return (
    <button
      className={cn(
        "absolute right-2 bottom-1 h-8 w-fit p-1 bg-transparent hover:bg-zinc-800/50 rounded text-zinc-400 hover:text-zinc-200 transition-colors cursor-pointer",
        className,
      )}
      onClick={
